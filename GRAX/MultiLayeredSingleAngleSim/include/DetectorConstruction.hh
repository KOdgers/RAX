...
class DetectorConstruction : public G4VUserDetectorConstruction
{
  public:
   ...
   ~DetectorConstruction();
    ...
    G4double GetSourcePoint() {return SeparationLength;};
  ...
  private:
    ...
    G4double fWorldSize;
    G4double WinnerRadius;
    G4double WouterRadius;
    G4double Whz;
    G4double startAngle ;
    G4double spanningAngle;
    G4double WorldBoxLength;
    //Am Dimensions
    G4double AmRad;
    G4double AmThick;
    G4double DeadThick;
    ...
    G4double SeparationLength;  //Half of the separation distance
