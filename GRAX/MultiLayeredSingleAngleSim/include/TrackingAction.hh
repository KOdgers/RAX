...
//Halfway through, need to link the pointers to event and run manager and build a better ftrackingaction
...
class TrackingAction : public G4UserTrackingAction {
  ...
  public:  
//    static TrackingAction* GetPointer();
//    TrackingAction();
