...
//TrackingAction* TrackingAction::fAction = 0;
////....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

//TrackingAction* TrackingAction::GetPointer()
//{
//  if(!fAction) {
//    static TrackingAction action;
//    fAction = &action;
//  }
//  return fAction;
//}
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
//void TrackingAction::BeginOfEvent()
//{
//  BetaEnergy=0;

//}

//void TrackingAction::ScoreNewTrack(const G4Track* Track)
//{

//}

//void TrackingAction::BeginOfRun(){
//    histfile.open("String.txt",std::ios::out);
//}

//void TrackingAction::EndOfRun(){
//    histfile.close();
//}
...
//void TrackingAction::AddTargetStep(const G4Step* Step)
//{
//    G4int LayerNumber = Step->GetPostStepPoint()->GetPhysicalVolume()->GetCopyNo();
//    histfile<<LayerNumber<<endl;
////    if(LayerNumber ==3){
////        G4double edep = Step->GetTotalEnergyDeposit()/keV;
////        BetaEnergy = BetaEnergy +edep;
////    }
//}
