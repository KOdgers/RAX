...
{  
  ...
  if( verboseLevel >= 1 ){
//      if (fStep->GetPostStepPoint()->GetPhysicalVolume()->GetCopyNo()==3){
////        if (fTrack->GetDefinition() == G4Gamma::Gamma()){
////          GammaEnergy =  fStep->GetTotalEnergyDeposit();
////      } else if (fTrack->GetDefinition()== G4Electron::Electron()){
////          BetaEnergy = fStep->GetTotalEnergyDeposit();
////      }
//////      G4cout<<"Beta Particles "<< BetaEnergy<<" Gamma Particles "<<G4endl;
//      }
